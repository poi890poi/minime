...
/** Frozen pre-optimization implementation from 1c2c51f, for differential regression only. */
final class ReferenceReadingIndex {
    private final String[] keys;
    private final List<Candidate>[] words;
    private final double[] best;
    private final int base;
    ReferenceReadingIndex(BinaryModel.Reader in)throws java.io.IOException {keys=in.strings();words=in.lists();best=in.doubles();base=in.in.readInt();}
    ...
    ReferenceReadingIndex(Map<String,List<Candidate>> source) {
