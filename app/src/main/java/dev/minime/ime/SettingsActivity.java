...
public final class SettingsActivity extends Activity {
    ...
    @Override public void onCreate(Bundle state) {
        ...
        text("Tap the bottom globe to switch Chinese/English, or use the idle 中 and En tabs. English offers completions, spelling alternatives and next words. Choosing a completion adds a space before your next word. Optional spelling correction acts on Space; immediate Backspace restores the spelling. Double Space within one second can insert a period. Chinese supports full, initial and mixed Pinyin syllables. The dark candidate is the Space choice. Chinese raw spelling appears above the choices; English exact input appears in the strip. Tap exact input or hold Space to keep the spelling. Swipe the candidate strip or use the down arrow to expand it. With Rime, selecting part of a phrase preserves the remaining phonetics for the next choice. Tap Shift once for one capital, twice quickly for Caps Lock, and once again to unlock. Capitals also follow the editor's sentence or word setting.",16);
