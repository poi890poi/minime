...
public final class SettingsActivity extends Activity {
    ...
    @Override public void onCreate(Bundle state) {
        ...
        option("Enable 日 mode · Chinese + English + Japanese", "addon_japanese",false);
        option("Enable 台 mode · Chinese + English + Taiwanese (POJ)", "addon_poj",false);
        text("Optional modes and dictionaries work offline and are off by default. 中 uses Chinese and English; 台 additionally queries Taiwanese; 日 additionally queries Japanese. English-focused mode queries neither Chinese nor third-language packs. Taiwan culture and geography options apply to all three mixed modes. Disabling an optional mode returns its mixed-mode selection to 中; existing pack settings and manual entries are retained. Full, initial and mixed reading matches follow the shared matching rules. Space accepts the dark highlighted candidate; prefix choices that consume only part of your input require a tap.",16);
