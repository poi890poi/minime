...
public final class SettingsActivity extends Activity {
    ...
    @Override public void onCreate(Bundle state) {
        ...
        text("Typing",21);
        text("Tap EN for English or 中 to return to your Chinese layout. English mode offers word completions and uses English punctuation. Tap a suggestion to choose it; the next word gets a space automatically. Space also inserts a space. Space otherwise keeps your typed spelling. Chinese mode accepts Pinyin or Zhuyin and still supports mixed English. The blue candidate is the Space choice. English + Space commits a real space; Chinese + Space accepts Chinese. The exact input stays at the left; tap it or hold Space to recover the spelling. Tap Shift once for one capital, twice quickly for Caps Lock, and once again to unlock. Holding Shift also locks capitals.",16);
